...
void main(void) {
    ...
    rdcenter = rotate( -normalize( ta - ro), 0.3*cos(time*0.25) );
    ...
    vec3 rd = normalize( p.x*camXform[0].xyz + p.y*camXform[1].xyz + 1.5 * camXform[2].xyz );
